...
// 	var config = [];
// 	var path_to_fixtures = path.join(__dirname, '..', '..', '..', settings.saved_crawls_path);
// 	var fixtures = fs.readdirSync(path_to_fixtures);
// 	_.each(fixtures, function(fixture){
// 		var file = fs.readFileSync(path.join(path_to_fixtures, fixture));
// 		data = JSON.parse(file);
// 		if (data.related_apis && data.related_apis.github){
// 			config.push(data.related_apis.github);
// 		}
// 	});
// 	return config;
// };
